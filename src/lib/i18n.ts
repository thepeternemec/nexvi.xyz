...
export const t = {
  en: {
    ...
    ctaSub: "Join 50,000+ humans using Prompt Academia to learn, create, and get hired.",
  ...
  de: {
    ...
    ctaSub: "Schließe dich 50.000+ Menschen an, die mit Prompt Academia lernen, erschaffen und Jobs finden.",
