...
export const copy: Record<Locale, Copy> = {
  en: {
    badge: "Beat AI. Land more interviews.",
    ...
    tools: [
      { title: "Find a Job Prompt Library", desc: "A curated library of battle-tested prompts for every stage of the hunt — CV, cover letter, interview, recruiter outreach, negotiation." },
      ...
      { title: "Humanizer", desc: "Strip AI tells from your CV or cover letter. Sound natural and human — with a side-by-side diff of every change.", badge: "Featured" },
    ],
    open: "Open",
    ...
    metaTitle: "Nexvi — AI That Tailors Your Experience to the Job",
    metaDesc: "Nexvi sits between your experience and the job description: rewriting, scoring and humanizing your CV and cover letter so you pass ATS filters and sound like yourself.",
  },
  de: {
    ...
    tools: [
      { title: "Job-Prompt-Bibliothek", desc: "Eine kuratierte Bibliothek erprobter Prompts für jede Phase der Jobsuche — Lebenslauf, Anschreiben, Interview, Recruiter-Outreach, Gehaltsverhandlung." },
      ...
      { title: "Humanizer", desc: "Entferne KI-Spuren aus deinem Lebenslauf oder Anschreiben. Klinge natürlich und menschlich — mit direktem Vorher-Nachher-Vergleich.", badge: "Empfohlen" },
    ],
    open: "Öffnen",
  ...
  es: {
    ...
    tools: [
      { title: "Biblioteca de Prompts", desc: "Una biblioteca curada de prompts probados para cada etapa de la búsqueda: CV, carta, entrevista, contacto con reclutadores, negociación." },
      ...
      { title: "Humanizer", desc: "Elimina las señales de IA de tu CV o carta. Suena natural y humano — con comparación lado a lado de cada cambio.", badge: "Destacado" },
    ],
    open: "Abrir",
  ...
  it: {
    ...
    tools: [
      { title: "Libreria di Prompt", desc: "Una libreria curata di prompt collaudati per ogni fase della ricerca — CV, lettera, colloquio, contatto recruiter, negoziazione." },
      ...
      { title: "Humanizer", desc: "Elimina i segnali di IA dal tuo CV o lettera. Suona naturale e umano — con confronto affiancato di ogni modifica.", badge: "In evidenza" },
    ],
    open: "Apri",
  ...
  fr: {
    ...
    tools: [
      { title: "Bibliothèque de Prompts", desc: "Une bibliothèque de prompts éprouvés pour chaque étape de la recherche — CV, lettre, entretien, contact recruteur, négociation." },
      ...
      { title: "Humanizer", desc: "Supprimez les traces d'IA de votre CV ou lettre. Sonnez naturel et humain — avec comparaison côte à côte de chaque changement.", badge: "À la une" },
    ],
    open: "Ouvrir",
