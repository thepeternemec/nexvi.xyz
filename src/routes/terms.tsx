...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms & Privacy — ApplyWise" },
      { name: "description", content: "ApplyWise terms of service and privacy policy: how we handle your CV data, AI processing, subscriptions and your rights under GDPR." },
  ...
  return (
    <SiteShell>
      <div className="mx-auto w-full max-w-3xl px-4 py-16 sm:px-6">
        ...
        <Section title="Using ApplyWise">
          <p>
            ApplyWise provides AI tools that generate CVs, cover letters, ATS analyses and rewritten text. You keep
          ...
          <p>
            Don't use ApplyWise to create misleading claims about your experience, to upload someone else's personal data
