...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nexvi — AI job application toolkit" },
      { name: "description", content: "Nexvi turns any job description into an ATS-ready CV, a tailored cover letter and a match score with concrete fixes." },
      { property: "og:site_name", content: "Nexvi" },
      { property: "og:title", content: "Nexvi — AI job application toolkit" },
      { property: "og:description", content: "Nexvi turns any job description into an ATS-ready CV, a tailored cover letter and a match score with concrete fixes." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" },
      { name: "twitter:title", content: "Nexvi — AI job application toolkit" },
      { name: "twitter:description", content: "Nexvi turns any job description into an ATS-ready CV, a tailored cover letter and a match score with concrete fixes." },
