...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Nexvi is the AI that turns your experience into better job applications: ATS-ready CVs, a tailored cover letter and a match score with concrete fixes." },
      { property: "og:site_name", content: "Nexvi" },
      { property: "og:title", content: "Nexvi — AI CV, Cover Letters & ATS Optimizer" },
      { property: "og:description", content: "Nexvi is the AI that turns your experience into better job applications: ATS-ready CVs, a tailored cover letter and a match score with concrete fixes." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "robots", content: "index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1" },
      { name: "twitter:title", content: "Nexvi — AI CV, Cover Letters & ATS Optimizer" },
      { name: "twitter:description", content: "Nexvi is the AI that turns your experience into better job applications: ATS-ready CVs, a tailored cover letter and a match score with concrete fixes." },
