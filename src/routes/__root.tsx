...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover, save, and use AI prompts that help you get a job, study smarter, create content, grow a business, and more. Made for everyday humans." },
      { property: "og:title", content: "Prompt Academia" },
